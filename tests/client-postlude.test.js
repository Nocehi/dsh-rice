...
test('rail Sessions reverses from hover state and Activity preserves its signal layer', async () => {
  ...
  assert.match(css, /dsh-rice-motion-search-line-3 \{ transition:transform 100ms cubic-bezier\(\.2,0,0,1\) 0ms; \}/u)
  assert.match(css, /\[data-dsh-rice-motion="search"\]:hover \.dsh-rice-motion-search-scanner \{ transform:translate3d\(4px,0,0\); transition-delay:0ms; \}/u)
  assert.match(css, /\[data-dsh-rice-motion="search"\]:hover \.dsh-rice-motion-search-line-1 \{ transform:scaleY\(1\.3\); transition-delay:30ms; \}/u)
  assert.match(css, /\[data-dsh-rice-motion="search"\]:hover \.dsh-rice-motion-search-line-3 \{ transform:scaleY\(1\.3\); transition-delay:90ms; \}/u)
  ...
  assert.match(css, /dsh-rice-motion-activity-shell-top \{ transition:clip-path 110ms cubic-bezier\(\.2,0,0,1\) 0ms; \}/u)
  assert.match(css, /dsh-rice-motion-activity-shell-bottom \{ transition:clip-path 110ms cubic-bezier\(\.2,0,0,1\) 70ms; \}/u)
  assert.match(css, /\[data-dsh-rice-motion="activity"\]:hover \.dsh-rice-motion-activity-shell-bottom \{ clip-path:inset\(0 0 0 100%\); transition-delay:0ms; \}/u)
  assert.match(css, /\[data-dsh-rice-motion="activity"\]:hover \.dsh-rice-motion-activity-shell-top \{ clip-path:inset\(0 0 0 100%\); transition-delay:70ms; \}/u)
