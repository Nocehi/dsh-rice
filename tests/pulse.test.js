...
test('activity policy keeps bounded samples, decays step velocity, and layers live boosts', () => {
...
test('displayed BPM uses a constant ramp rather than snapping to the target', () => {
