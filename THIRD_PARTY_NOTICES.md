...
`dsh-rice` embeds SVG path data from **Material Symbols Rounded** by Google for the v0 application rail.

Embedded assets:

- `search`, 20px: `symbols/web/search/materialsymbolsrounded/search_20px.svg`
- `add`, 20px: `symbols/web/add/materialsymbolsrounded/add_20px.svg`
- `browse_activity`, 20px: `symbols/web/browse_activity/materialsymbolsrounded/browse_activity_20px.svg`
